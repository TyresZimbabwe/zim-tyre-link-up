  ...
  return (
    <div className="relative bg-tyreBlue text-white">
      <div className="absolute inset-0 bg-gradient-to-r from-tyreBlue/90 to-tyreBlue/70">
        <div className="absolute inset-0 bg-[url('https://unsplash.com/photos/a-yellow-bulldozer-sitting-on-top-of-a-pile-of-dirt-hEYfitmmb-M?q=80&w=1920&auto=format')] bg-cover bg-center mix-blend-overlay opacity-40"></div>
      </div>
