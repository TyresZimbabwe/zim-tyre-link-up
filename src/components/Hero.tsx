  ...
  return (
    <div className="relative bg-tyreBlue text-white">
      <div className="absolute inset-0 bg-gradient-to-r from-tyreBlue/90 to-tyreBlue/70">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1590759668628-05b0fc34bb70?q=80&w=1920&auto=format')] bg-cover bg-center mix-blend-overlay opacity-40"></div>
      </div>
