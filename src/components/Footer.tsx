...
const Footer = () => {
  return (
    <footer className="bg-tyreDarkGray text-white pt-10 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/find-size" className="text-gray-300 hover:text-white">Find My Size</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/payment" className="text-gray-300 hover:text-white">Payment Methods</Link>
              </li>
              <li>
                <Link to="/warranty" className="text-gray-300 hover:text-white">Warranty Information</Link>
              </li>
            </ul>
          </div>
